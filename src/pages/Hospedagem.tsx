        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-petrohost-textGray max-w-3xl mx-auto">
              Descubra a solução de hospedagem perfeita para o seu projeto. Oferecemos performance, segurança e o melhor suporte.
            </p>
          </div>
          ...
          <div className="bg-petrohost-lightGray rounded-2xl p-12 text-center">
            ...
            <p className="text-petrohost-textGray">
              Esta página será desenvolvida com todos os planos de hospedagem detalhados.
            </p>
          </div>
        </div>
      </main>
